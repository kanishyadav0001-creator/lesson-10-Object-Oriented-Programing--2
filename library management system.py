class Library:
    ...
    def displayBooks(self):
     ...
     def lendBook(self,user,book):
         ...
         else:print(f"Book is already being used by{self.lendDict[book]}")
...
if __name__ == '__main__':
     ...
     books = Library(['Python', 'Rich dad poor dad','Harry Porter','C++ Basics','Algorithms by CLRS'],"Let's Upskill")
